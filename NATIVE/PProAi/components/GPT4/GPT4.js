...
const GPT4 = ({ navigation }) => {
  ...
  useEffect(() => {
    addMessage("Hello! I am ALLIN GPT 4 chat! How may I assist you today?", 'bot');
  }, []);
  ...
  const sendMessage = () => {
    ...
    fetch('https://p-pro.eu/api/gpt4.php/', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  const clearChat = () => {
    ...
    setMessages([{ content: "Hello! I am ALLIN GPT 4 chat! How may I assist you today?", sender: 'bot' }]);
  }
...
const styles = StyleSheet.create({
  ...
  messageContainer: sender => ({
    ...
    backgroundColor: sender === 'bot' ? '#ddd' : '#FF9E00',
    borderRadius: 20,
    marginTop: 10,
    padding: 10,
    maxWidth: '80%',
