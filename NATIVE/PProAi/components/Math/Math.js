...
const Math = ({ navigation }) => {
  ...
  const sendMessage = () => {
    ...
    fetch('https://p-pro.eu/api/math.php/', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TextInput style={styles.textInput} placeholder='Enter math problem to solve' onChangeText={setInputMessage} value={inputMessage} placeholderTextColor="#575757"/>
      <Button title='Solve' onPress={sendMessage} disabled={isLoading} />
