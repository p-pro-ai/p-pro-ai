 ...
 switch ($plan_status) {
    case 'basic':
        if ($total_messages >= 50) {
            $return = array(
                'message' => 'I am sorry, you have reached your limit for the month. You can upgrade your plan, wait till the '.$next_billing.' or just use the ALLIN GPT 3.5 chat. Thank you! 
