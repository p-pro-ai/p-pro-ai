...
switch ($plan_status) {
    case 'basic':
        if ($total_messages >= 300) {
            $return = array(
                'message' => 'I am sorry, you have reached your limit for the month. You can upgrade your plan or wait till the '.$next_billing.'. Thank you! <br> Upgrare your plan here: <a href="pricing.php">https://p-pro.eu/ai/pricing.php/</a>',
                'time' => $datetime
            );
